const en = {
  translation: {
    ...
    orderParts: {
      ...
      add: "Add part",
      empty: "No parts have been issued for this order.",
      totalCost: "Total parts cost",
      summary: {
        part: "Part",
        issued: "Issued",
        returned: "Returned",
        used: "Used",
        unitCost: "Average write-off price",
        total: "Cost",
        stock: "In stock",
        actions: "Actions",
      },
      ...
      addDialog: {
        title: "Issue a part to the order",
        searchLabel: "Search by name, SKU or barcode",
        searchHint: "Enter at least 2 characters.",
        noResults: "No parts were found.",
        quantity: "Quantity",
        unitCost: "Write-off price per unit",
        available: "Available",
        purchasePrice: "Purchase price",
        total: "Total write-off amount",
        note: "Note",
      },
      returnDialog: {
        title: "Return a part to inventory",
        description: "Part: {{name}}. Currently used in this order: {{quantity}}.",
        quantity: "Quantity to return",
        unitCost: "Return price per unit",
        note: "Return reason",
      },
      actions: {
        cancel: "Cancel",
      ...
      validation: {
        quantity: "Enter a whole quantity greater than zero.",
        stock: "There is not enough stock available.",
        cost: "The price must be a number of zero or more.",
        returnQuantity: "The quantity cannot exceed the amount actually issued.",
      },
      success: {
        issued: "The part was issued to the order.",
        returned: "The part was returned to inventory.",
      },
      errors: {
        returnExceeds: "You cannot return more than was issued to this order.",
      },
    },
    ...
    inventoryPage: {
      ...
      errors: {
        ...
        previewFailed: "The inventory import preview could not be loaded.",
        importFailed: "The inventory import could not be completed.",
      ...
      import: {
        ...
        fileHint: "Supported formats: .xlsx, .xls and .csv. The first non-empty row is used as the column header. A maximum of 1000 data rows can be imported at once.",
        sheet: "Worksheet",
        sheetInfo: "Header row: {{header}} · data rows: {{rows}}",
        mappingTitle: "Column mapping",
        mappingHint: "Columns are matched automatically when possible. Check the required SKU, Name and Category fields before previewing.",
        notMapped: "Not mapped",
        preview: "Preview import",
        previewing: "Checking...",
        previewTitle: "Import preview",
        executionTitle: "Import settings",
        duplicateAction: "Action for existing items",
        skipInvalid: "Skip {{count}} invalid or conflicting rows and import the remaining valid rows",
        execute: "Import inventory",
        importing: "Importing...",
        reportTitle: "Import completed",
        importAnother: "Import another file",
        completedMessage: "Inventory import completed: {{created}} created, {{updated}} updated.",
        fields: {
          sku: "SKU",
          supplierSku: "Supplier SKU",
          barcode: "Barcode",
          ...
          note: "Note",
          isActive: "Active",
          action: "Per-row action",
        },
        previewSummary: {
          totalRows: "Total rows",
          newRows: "New",
          duplicateRows: "Existing",
          invalidRows: "Invalid",
          conflictRows: "Conflicts",
          fileDuplicateRows: "Duplicates in file",
        },
        columns: {
          row: "Row",
          status: "Status",
        ...
        status: {
          ...
          invalid: "Invalid",
          conflict: "Conflict",
          file_duplicate: "Duplicate in file",
        },
        duplicateActions: {
          skip: "Skip existing items",
          update: "Update item data, keep stock",
          add_quantity: "Update data and add quantity",
          replace: "Update data and replace stock",
        },
        duplicateHelp: {
          skip: "Existing items are left unchanged.",
          update: "Mapped item data is updated, but the current stock quantity is not changed.",
          add_quantity: "The imported quantity is added to the current stock and a receipt movement is recorded.",
          replace: "The current stock is adjusted to the imported quantity and an adjustment movement is recorded.",
        },
        report: {
          created: "Created",
          updated: "Updated",
          quantityAdded: "Quantity added",
          quantityReplaced: "Stock replaced",
          skipped: "Skipped",
          skippedInvalid: "Invalid skipped",
          movementsCreated: "Movements created",
          quantityDelta: "Total quantity change",
        },
        errors: {
          unsupportedFile: "Choose an .xlsx, .xls or .csv file.",
          emptyFile: "The selected file or worksheet contains no usable data.",
          fileRead: "The file could not be read.",
          tooManyRows: "Reduce the file to 1000 data rows or fewer.",
          requiredMapping: "Map the required SKU, Name and Category columns.",
          quantityMappingRequired: "Map the Quantity column for the selected duplicate strategy.",
          blocked: "The import contains invalid, conflicting or repeated rows. Correct them or explicitly allow those rows to be skipped.",
          rowsRequired: "No import rows were provided.",
          tooLarge: "A maximum of 1000 rows can be imported at once.",
          invalidAction: "One of the row actions is not valid for that row.",
          invalidStrategy: "The selected duplicate strategy is not supported.",
          conflict: "Some identifiers point to different inventory items.",
          server: "The inventory import failed on the server.",
        },
      },
      apiErrors: {
