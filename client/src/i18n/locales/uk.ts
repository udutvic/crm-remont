  ...
  translation: {
    ...
    ordersPage: {
      ...
      actions: {
        ...
        archive: "Архівувати замовлення",
      },
      archiveConfirmation:
        'Архівувати замовлення "{{id}}"? Воно зникне з активних списків, але історія, запчастини й фотографії збережуться.',
      archiveDialog: {
      ...
      errors: {
        ...
        archiveFailed: "Не вдалося архівувати замовлення.",
      },
    },
